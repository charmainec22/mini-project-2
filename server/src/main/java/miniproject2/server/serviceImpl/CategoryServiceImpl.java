...
public class CategoryServiceImpl implements CategoryService {
    ...
    public ResponseEntity<String> addNewCategory(Map<String, String> requeMap) {
        try {
            if (jwtFilter.isAdmin()) {
                ...
                if (validateCategoryMap(requeMap, false)) {

                    categoryDao.save(getCategoryFromMap(requeMap, false));
    ...
    private boolean validateCategoryMap(Map<String, String> requeMap, boolean validateId) {
    ...
    public ResponseEntity<String> updateCategory(Map<String, String> requeMap) {
        try {
            ...
            if (jwtFilter.isAdmin()) {
                ...
                if (validateCategoryMap(requeMap, true)) {

                    Optional optional = categoryDao.findById(Integer.parseInt(requeMap.get("id")));
                    if (!optional.isEmpty()){
                        categoryDao.save(getCategoryFromMap(requeMap, true));
