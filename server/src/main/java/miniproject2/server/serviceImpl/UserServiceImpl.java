...
import miniproject2.server.JWT.CustomerUsersDetailsService;
import miniproject2.server.JWT.JwtFilter;
import miniproject2.server.JWT.JwtUtil;
...
import miniproject2.server.utils.EmailUtils;
    ...
    public ResponseEntity<String> forgotPassword(Map<String, String> requestMap) {
       try {
        ...
        if (!Objects.isNull(user) && !Strings.isNullOrEmpty(user.getEmail())) 
            ...
            emailUtils.forgotMail(user.getEmail(), "Credentials by System", user.getPassword());
